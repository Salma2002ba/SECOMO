      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-zinc-900/95 backdrop-blur-xl rounded-2xl shadow-2xl shadow-violet-950/30 border border-zinc-700/50 p-8 lg:p-10">
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              onSuccess(email || 'demo@secomo.io');
            }}
          >
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white font-bold py-3.5 rounded-xl transition-all duration-300 shadow-lg shadow-violet-500/25 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 group"
            >
              {type === 'login' ? 'Se connecter' : 'Créer un compte'}
              <i className="fas fa-arrow-right text-sm group-hover:translate-x-1 transition-transform duration-300 opacity-80" />
            </button>
          </form>
